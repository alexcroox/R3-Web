L.Control.Measure = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        this._createButton('&#8674;', 'Measure Distances', 'leaflet-control-measure leaflet-bar-part leaflet-bar-part-top-and-bottom', container, this._toggleMeasure, this);
    ...
    _mouseMove: function(e) {
        ...
        if(this._tooltip) {
            ...
            var distanceRaw = playBack.map.rc.project(e.latlng);

            var distance = distanceRaw.distanceTo(playBack.map.rc.project(this._lastPoint));
    ...
    _round: function(val) {
        //console.log(val);
        var divideBy = (playBack.map.config.doubleSize == "1")? 2 : 1;
        return Math.round(val / divideBy);
    },
